# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/11_create_climate_data.ipynb.

# %% auto 0
__all__ = ['ClimateDataValidation', 'create_climate_data']

# %% ../nbs/11_create_climate_data.ipynb 3
import os
import numpy as np
import pandas as pd
...
# %% ../nbs/11_create_climate_data.ipynb 4
...
def create_climate_data(
    ...
    if modeling_options['constant_climate'] is False:
        ...
        climate_data.index = np.arange(1, len(climate_data) + 1)
